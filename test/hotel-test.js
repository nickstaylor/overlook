...
describe('Hotel', function() {
  ...
  describe('Hotel Methods', function() {
    ...
    it('should be able to filter rooms by type', function() {
      hotel.allRooms.push(room1, room2, room3)
      hotel.allBookings.push(booking1, booking2, booking3)
      let filteredRooms = hotel.filterRoomsByType(date, roomType)
      expect(filteredRooms).to.deep.eq([{
        number: 1,
        roomType: "residential suite",
        bidet: true,
        bedSize: "queen",
    ...
    it('should be able to find rooms available by date', function() {
      hotel.allRooms.push(room1, room2, room3)
      hotel.allBookings.push(booking1, booking2, booking3)
      let roomsAvail = hotel.findAvailableRoomsByDate(date)
      expect(roomsAvail).to.deep.eq([{
        number: 1,
        roomType: "residential suite",
        bidet: true,
        bedSize: "queen",
